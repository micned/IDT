...
call(['python', 'Out-of-scanner discounting.py', sid, exp, probability, losses, past, explicit0, commodityD, commodityI, amountD, amountI, os.path.dirname(sys.argv[0]), taskpause, 'n']) 
